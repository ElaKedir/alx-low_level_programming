 ...
 * purpose is to maintain  constant function prototype.
 *
 * Return: Always 0
 */
...
/**
 * ela_getenv - A functions that gets the value of an environ variable
 * @info: A structure that contains arguments to be used in functions
 * its purpose is to maintain  constant function prototype.
 * @name: env var name
 *
 * Return: the value
 */
...
/**
 * elaela__setenv - A function that initialize a new environment variable,
...
/**
 * populate_envlist - A function thath populates env linked list
 * @info: A structure that contains arguments to be used in functions
 * its purpose is to maintain  constant function prototype.
 *
 * Return: Always 0
