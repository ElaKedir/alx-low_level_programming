...
/**
 * add_n_shash - A function that adds a node at the beginning
...
/**
 * add_i_shash - A function that adds a node on the DLL of the shash table
 *
...
/**
 * shash_table_set - A function that adds a hash (key, value) to a given
 * shash table
 *
...
/**
 * shash_table_get - A function that retrieves a value associated
 * with a key
 *
 * @ht: the pointer to the shash table
 * @key: the key of the shash
...
/**
 * shash_table_print - A function that prints the keys and
...
/**
 * shash_table_print_rev - A function that prints the keys and values
